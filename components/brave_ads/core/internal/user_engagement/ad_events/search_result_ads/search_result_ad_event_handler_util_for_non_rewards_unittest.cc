...
TEST_F(BraveAdsSearchResultAdEventHandlerUtilForNonRewardsTest,
       CannotFireViewedEventWithConversion) {
  // Arrange
  const mojom::CreativeSearchResultAdInfoPtr mojom_creative_ad =
      test::BuildCreativeSearchResultAdWithConversion(
          /*should_generate_random_uuids=*/true);
...
TEST_F(BraveAdsSearchResultAdEventHandlerUtilForNonRewardsTest,
       CannotFireViewedEventWithoutConversion) {
  // Arrange
  const mojom::CreativeSearchResultAdInfoPtr mojom_creative_ad =
      test::BuildCreativeSearchResultAd(/*should_generate_random_uuids=*/true);
...
TEST_F(BraveAdsSearchResultAdEventHandlerUtilForNonRewardsTest,
       CannotFireNonClickedEventWithConversion) {
  // Arrange
  const mojom::CreativeSearchResultAdInfoPtr mojom_creative_ad =
      test::BuildCreativeSearchResultAdWithConversion(
          /*should_generate_random_uuids=*/true);
...
TEST_F(
    ...
    CannotFireClickedEventWithConversionIfShouldNotAlwaysTriggerSearchResultAdEvents) {
  // Arrange
...
TEST_F(BraveAdsSearchResultAdEventHandlerUtilForNonRewardsTest,
       CannotFireClickedEventWithoutConversion) {
  // Arrange
  const mojom::CreativeSearchResultAdInfoPtr mojom_creative_ad =
      test::BuildCreativeSearchResultAd(/*should_generate_random_uuids=*/true);
