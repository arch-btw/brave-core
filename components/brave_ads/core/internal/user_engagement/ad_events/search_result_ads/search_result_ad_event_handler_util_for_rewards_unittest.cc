...
TEST_F(BraveAdsSearchResultAdEventHandlerUtilForRewardsTest,
       CanAlwaysFireEventWithConversion) {
  // Arrange
  const mojom::CreativeSearchResultAdInfoPtr mojom_creative_ad =
      test::BuildCreativeSearchResultAdWithConversion(
          /*should_generate_random_uuids=*/true);
  ...
  for (int i = 0;
       i < static_cast<int>(mojom::SearchResultAdEventType::kMaxValue); ++i) {
    const auto event_type = static_cast<mojom::SearchResultAdEventType>(i);
    EXPECT_TRUE(CanFireEvent(mojom_creative_ad, event_type));
  }
}

TEST_F(BraveAdsSearchResultAdEventHandlerUtilForRewardsTest,
       CanAlwaysFireEventWithoutConversion) {
  // Arrange
  const mojom::CreativeSearchResultAdInfoPtr mojom_creative_ad =
...
TEST_F(BraveAdsSearchResultAdEventHandlerUtilForRewardsTest,
       CanFireEventIfAdPlacementWasServed) {
  // Arrange
  const mojom::CreativeSearchResultAdInfoPtr mojom_creative_ad =
      test::BuildCreativeSearchResultAdWithConversion(
          /*should_generate_random_uuids=*/true);
  ...
  // Act & Assert
  EXPECT_TRUE(CanFireEvent(ad, ad_events,
                           mojom::SearchResultAdEventType::kViewedImpression));
}

TEST_F(BraveAdsSearchResultAdEventHandlerUtilForRewardsTest,
       CannotFireEventIfAdPlacementWasNeverServed) {
  // Arrange
  const mojom::CreativeSearchResultAdInfoPtr mojom_creative_ad =
      test::BuildCreativeSearchResultAdWithConversion(
          /*should_generate_random_uuids=*/true);
  ...
  // Act & Assert
  EXPECT_FALSE(CanFireEvent(ad, /*ad_events=*/{},
                            mojom::SearchResultAdEventType::kViewedImpression));
}

TEST_F(BraveAdsSearchResultAdEventHandlerUtilForRewardsTest,
       CanFireNonDuplicateViewedEvent) {
  // Arrange
  const mojom::CreativeSearchResultAdInfoPtr mojom_creative_ad =
      test::BuildCreativeSearchResultAdWithConversion(
          /*should_generate_random_uuids=*/true);
...
TEST_F(BraveAdsSearchResultAdEventHandlerUtilForRewardsTest,
       CannotFireDuplicateViewedEvent) {
  // Arrange
  const mojom::CreativeSearchResultAdInfoPtr mojom_creative_ad =
      test::BuildCreativeSearchResultAdWithConversion(
          /*should_generate_random_uuids=*/true);
...
TEST_F(BraveAdsSearchResultAdEventHandlerUtilForRewardsTest,
       CanFireNonDuplicateClickedEvent) {
  // Arrange
  const mojom::CreativeSearchResultAdInfoPtr mojom_creative_ad =
      test::BuildCreativeSearchResultAdWithConversion(
          /*should_generate_random_uuids=*/true);
  ...
  // Act & Assert
  EXPECT_TRUE(
      CanFireEvent(ad, ad_events, mojom::SearchResultAdEventType::kClicked));
}

TEST_F(BraveAdsSearchResultAdEventHandlerUtilForRewardsTest,
       CannotFireDuplicateClickedEvent) {
  // Arrange
  const mojom::CreativeSearchResultAdInfoPtr mojom_creative_ad =
      test::BuildCreativeSearchResultAdWithConversion(
          /*should_generate_random_uuids=*/true);
